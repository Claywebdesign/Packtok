...
async function getManpowerServices(): Promise<ServiceRequest[]> {
  try {
    ...
    return response.data.filter(service => service.serviceType === ServiceType.MANPOWER_HIRING);
  } catch (error) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Manpower Hiring Services</h1>
