...
async function getJobSeekerServices(): Promise<ServiceRequest[]> {
  try {
    ...
    return response.data.filter(service => service.serviceType === ServiceType.JOB_SEEKER_SUBMISSION);
  } catch (error) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Job Seeker Services</h1>
